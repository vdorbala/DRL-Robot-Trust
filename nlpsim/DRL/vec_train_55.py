...
def train():
    ...
    for experiment in range(NUM_EXPERIMENTS):
        ...
        train_env.reset()
        model = ALGO(CustomPolicy, train_env, n_steps=15, nminibatches=5, learning_rate=0.1, tensorboard_log="./vector_logs_new5/", verbose=1)
        start = time.time()
    ...
    model.save("hricra_train55_{}".format(time.time()))
