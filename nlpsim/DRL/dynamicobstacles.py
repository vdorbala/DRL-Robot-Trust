...
class DynamicObstaclesEnv(MiniGridEnv):
    ...
    def step(self, action):
        ...
        self.time_elapse = 0
        # print("Time elapse now is {}".format(self.time_elapse))
        print("Rewards are r_i: {}, r_t: {}, r_g: {}, r_soc: {}, r_conf: {} r_wall: {} total = {}".format(self.r_i, self.r_t, self.r_g, self.r_soc, self.r_conf, self.r_wall, reward))
    ...
    def step(self, action):
        ...
        #     if front_cell == 'goal' or cur_cell=='goal':
            if (self.gcount == self.GMIN):
                ...
                self.r_g += -50*(self.gcount - self.GMIN)
        ...
        r_wall = 0
        if front_cell is not None:
            if cur_act == 3 or front_cell == 'wall':
                self.r_wall += -1000
                done = True
