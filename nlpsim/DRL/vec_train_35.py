...
def train():
    ...
    for experiment in range(NUM_EXPERIMENTS):
        ...
        train_env.reset()
        model = ALGO('MlpPolicy', train_env, n_steps=15, batch_size=5, learning_rate=0.1, tensorboard_log="./vector_logs_new3/", verbose=1)
        start = time.time()
    ...
    model.save("hricra_train35_{}".format(time.time()))
